    ...
    def setUpTestData(cls):
        ...
        for author_id in range(number_of_authors):
            Author.objects.create(
                first_name="Christian {0}".format(author_id), last_name="Surname {0}".format(author_id)
            )
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def test_only_borrowed_books_in_list(self):
        ...
        for bookitem in response.context["bookinstance_list"]:
            ...
            self.assertEqual(2, bookitem.status)
...
class RenewBookInstancesViewTest(TestCase):
    def setUp(self):
        ...
        self.test_bookinstance1 = BookInstance.objects.create(
            book=test_book, imprint="Unlikely Imprint, 2016", due_back=return_date, borrower=test_user1, status=2
        )
